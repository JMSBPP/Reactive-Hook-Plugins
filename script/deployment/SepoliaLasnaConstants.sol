...
uint256 constant LASNA_CHAIN_ID = uint256(0x512577);
uint256 constant SEPOLIA_CHAIN_ID = uint256(0xaa36a7);
...
address constant HOOK_CALLBACK_SEPOLIA_ADDRESS = address(0x80DF46c1FBC74aFeEa29afc6Cfd199F00eF9E000);
